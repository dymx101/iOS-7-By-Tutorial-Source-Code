...
- (void)startAdvertising {
    UIActionSheet *actionSheet = [[UIActionSheet alloc] initWithTitle:@"Select Beacon" delegate:self cancelButtonTitle:@"Cancel" destructiveButtonTitle:nil otherButtonTitles:@"Core Cupcakes", @"@synthesize salads", @"Weak Wraps", nil];
