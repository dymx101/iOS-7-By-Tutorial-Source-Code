...
@implementation BookView
{
    ...
    NSUInteger _currentCharacterLocation;
}
...
- (void)buildFrames {
    ...
    [self navigateToCharacterLocation:_currentCharacterLocation];
...
- (void) buildViewsForCurrentOffset {
    ...
    for(NSUInteger index = 0; index < _layoutManager.textContainers.count; index++) {
        ...
        if (textViewRect.origin.x > self.contentOffset.x) {
            ...
            _currentCharacterLocation = charRange.location;
            break;
        }
    }
